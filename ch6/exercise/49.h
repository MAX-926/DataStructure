#ifndef CH6_DOUBLE_CIRCULAR_LIST_H
#define CH6_DOUBLE_CIRCULAR_LIST_H
...
template<class T>
doubleCircularList<T>::doubleCircularList(const doubleCircularList<T> &theDCL)//O(listSize)
{
...
#endif //CH6_DOUBLE_CIRCULAR_LIST_H
