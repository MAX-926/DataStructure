...
int main()
{
    // tree<int> = new pair<bool, int>[numberOfNode + 1];
    // for(int i = 0; i < numberOfNode + 1; i++)
    //     tree<int>[numberOfNode].first = false;
    // for(int i = 1; i <= numberOfNode; i++)
    // {
    //     tree<int>[i].first = true; tree<int>[i].second = i;
    // }
    // preOrder<int>(tree<int>, 1, numberOfNode);
    ...
    preOrder<char>(tree<char>, 1, numberOfNode);
